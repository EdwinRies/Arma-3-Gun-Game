...
#define SET_PTR(x,val) ([PTR_MAIN, x , val] call VOR_fnc_pointerSet)
#define GET_PTR(x) ([PTR_MAIN, x] call VOR_fnc_pointerGet)
#define NEW_PTR(val) ([PTR_MAIN, val] call VOR_fnc_pointerNew)
