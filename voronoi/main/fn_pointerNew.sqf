...
if(isNil "_num" || { !(_num isEqualType 0) }) exitWith {
	["Invalid parameter ""container"" - Container not properly initilized, only pass containers created using VOR_fnc_pointerNewContainer. Parameters received: %1", _this] call BIS_fnc_error;
};
