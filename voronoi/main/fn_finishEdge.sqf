...
[_leftChildPtr, _width, _height, _vertices] call VOR_fnc_finishEdge;
[_rightChildPtr, _width, _height, _vertices] call VOR_fnc_finishEdge;
DEL_PTR(_nPtr);