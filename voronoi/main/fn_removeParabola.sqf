/*
	...
	Function: VOR_fnc_removeParabola
...
private _leftParentPtr = [_p1Ptr, true] call VOR_fnc_treeGetParent;
private _rightParentPtr = [_p1Ptr, false] call VOR_fnc_treeGetParent;

private _p0Ptr = [_leftParentPtr, true] call VOR_fnc_treeGetLeafChild;
private _p2Ptr = [_rightParentPtr, false] call VOR_fnc_treeGetLeafChild;
...
private _pointP = [_eventPoint#POINT_X, [_p1#PARABOLA_SITE, _eventPoint#POINT_X, _scanlineY] call VOR_fnc_getY];
...
private _parentEdge = [_pointP, _p0#PARABOLA_SITE, _p2#PARABOLA_SITE] call VOR_fnc_newEdge;
...
if(GET_PTR(_p1GrandparentPtr)#PARABOLA_LEFT == _p1ParentPtr) then {
	[_p1GrandparentPtr, _siblingPtr, true] call VOR_fnc_treeSetChild;
};
if(GET_PTR(_p1GrandparentPtr)#PARABOLA_RIGHT == _p1ParentPtr) then {
	[_p1GrandparentPtr, _siblingPtr, false] call VOR_fnc_treeSetChild;
};
